...
def llenarBD(cantidad):
    ...
    while i < cantidad :
        try:
            ...
            enf = [generarOpcion(),
            generarOpcion(),generarOpcion(),generarOpcion(),generarOpcion(),generarOpcion(),generarOpcion(),
            generarOpcion(),generarOpcion(),documento]
            cursor.execute("INSERT INTO pacienteEnfermedades VALUES (?,?,?,?,?,?,?,?,?,?)",enf)

            sin =[generarOpcion(),
            generarOpcion(),generarTemperatura(),generarOpcion(),generarOpcion(),generarOpcion(), documento]
            cursor.execute("INSERT INTO pacienteSintomas VALUES (?,?,?,?,?,?,?)",sin)
